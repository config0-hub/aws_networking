...
def run(stackargs):
    ...
    stack.parse.add_required(key="vpc_peering_name",
                             tags="tfvar,db",
                             types="str")
    stack.parse.add_required(key="vpc_peering_connection_id",
                             tags="tfvar",
                             types="str")
    stack.parse.add_required(key="vpc_a_id",
                             tags="tfvar",
                             types="str")
    stack.parse.add_required(key="vpc_a_route_table_id",
                             tags="tfvar",
                             types="str")
    stack.parse.add_required(key="vpc_a_cidr_block",
                             tags="tfvar",
                             types="str")
    stack.parse.add_required(key="vpc_b_id",
                             tags="tfvar",
                             types="str")
    stack.parse.add_required(key="vpc_b_route_table_id",
                             tags="tfvar",
                             types="str")
    stack.parse.add_required(key="vpc_b_cidr_block",
                             tags="tfvar",
                             types="str")
    ...
    stack.add_execgroup("config0-hub:::aws_networking::vpc_peering_accept",
                        "tf_execgroup")
